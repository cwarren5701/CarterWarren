public class MockDatabase {
    ...
    static MockDatabase() {
        ...
        Videos.Add(new Video("/videos/West Coast Elite Sophomore Full AAU highlights(2021) .mp4", "/imgs/SophomoreWCE.png", "Sophomore Year Highlights (AAU)", "West Coast Elite (2020-2021)", "/SophomoreWCE"));
    }
}